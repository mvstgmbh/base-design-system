...
export const EyeIcon = () => (
  <svg xmlns='http://www.w3.org/2000/svg' width='40' height='41' viewBox='0 0 40 41' fill='none'>
    <path
      ...
      fill={twFullConfig.theme.colors.primary[700]}
    />
  </svg>
);
        ...
        <div className='relative grid grid-cols-2 gap-4xl py-[70px] overflow-hidden pb-20'>
          <div className='w-full pl-7xl max-w-2xl flex flex-col gap-3xl overflow-hidden'>
            ...
            <div className='w-full flex gap-lg'>
              <Badge variant='primary' className='text-primary-700 bg-primary-100'>
                What’s new
              </Badge>
            ...
            <Typography as='p' variant='subHeading' className='text-neutral-900/50'>
              Lorem ipsum dolor sit amet consectetur. Ac sem viverra proin ac. Velit pretium quisque
              enim molestie. Nullam sagittis consequat malesuada nisl amet amet lectus.
            </Typography>
